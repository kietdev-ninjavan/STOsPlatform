...
class TokenManager(metaclass=SingletonMeta):
    ...
    TOKEN_CACHE_KEY = "driver_auth_token"
    ...
    def update_token(self) -> None:
        ...
        card = self._build_card(
            header='<font color="#de1304">Driver Token Expired</font>',
...
class BaseService(ABC):
    ...
    def __init__(self, logger: logging.Logger = logging.getLogger(__name__)):
        ...
        self.phone_imei = '350209363548036'
        self.driver_id = 1682343
    ...
    def _set_session_headers(self) -> None:
        ...
        self.session.headers.update({
            ...
            'X-Nv-App-Version': '827000000',
            'X-Nv-App-Code': 'driver',
            'X-Nv-App-User-Id': f'{self.driver_id}',
        })
    ...
    def make_request(self, url: str, method: str = 'GET', payload: Any = None, data: Any = None, files: dict = None) -> tuple:
        """
        ...
        try:
            ...
            response = self.session.request(method, url, json=payload, data=data, files=files)
