...
def wms_dispose():
    ...
    shein_orders = [
        order["tracking_id"] for order in pending_pick_orders if order["global_shipper_id"] == 7512979 and order["pick_action"] == "DISPOSE" and order["bin_id"] in current_bin_ids
    ]
