...
@shared_task(name='[SLA Tool] collect_call_data_task', base=STOsTask)
...
# region Shopee
@shared_task(name='[SLA Tool] collect_shopee_backlogs_task', base=STOsTask)
def collect_shopee_backlogs_task():
    collect_shopee_backlogs()


@shared_task(name='[SLA Tool] collect_shopee_extend_sla_task', base=STOsTask)
def collect_shopee_extend_sla_task():
    collect_extend_sla()


@shared_task(name='[SLA Tool] calculate_shopee_sla_date_task', base=STOsTask)
def calculate_shopee_sla_date_task():
    calculate_sla_date_shopee()


@shared_task(name='[SLA Tool] load_shopee_order_info_task', base=STOsTask)
...
# region TikTok
@shared_task(name='[SLA Tool] collect_tiktok_backlogs_task', base=STOsTask)
def collect_tiktok_backlogs_task():
    collect_tiktok_backlogs()


@shared_task(name='[SLA Tool] calculate_tiktok_sla_date_task', base=STOsTask)
def calculate_tiktok_sla_date_task():
    calculate_sla_date_tiktok()


@shared_task(name='[SLA Tool] load_tiktok_order_info_task', base=STOsTask)
...
@shared_task(name='[SLA Tool] out_to_sheet_task', base=STOsTask)
